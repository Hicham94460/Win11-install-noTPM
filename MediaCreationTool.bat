@goto latest at https://github.com/Hicham94460/Win11-install-noTPM
...
@echo off& title MCT %uiver% by Hicham94460& set __COMPAT_LAYER=Installer& chcp 437 >nul& set set=& for %%s in (%*) do if /i %%s equ set (set set=1)
